...
public class LocalisationService {
    ...
    private LocalisationService() {
        ...
        //english = ResourceBundle.getBundle("localisation.languages", new Locale("en", "US"), loader);
        //supportedLanguages.put("en", "English");
        russian = ResourceBundle.getBundle("localisation.languages", new Locale("ru", "RU"), loader);
